...
<div class="main-container">
   <a href="/launchpage"><button class="break" style="margin-left:-1300px;color:white;background-color:blue;border-radius:22px;width:5%;cursor: pointer;">Back</button></a>
